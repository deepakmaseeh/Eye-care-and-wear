...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      primary:
        'bg-brand-primary text-text-inverse hover:bg-brand-primary-hover active:bg-brand-primary-active hover:-translate-y-0.5 hover:shadow-dark-md active:translate-y-0 shadow-dark-sm',
      secondary:
        'bg-transparent border-2 border-border-primary text-text-primary hover:border-brand-primary hover:text-brand-primary hover:bg-brand-primary/8',
