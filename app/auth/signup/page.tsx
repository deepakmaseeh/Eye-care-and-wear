      ...
      <div className="min-h-screen">
        ...
        <div className="container-custom py-16">
          <Card className="max-w-md mx-auto text-center">
            ...
            <h2 className="text-2xl font-bold font-heading mb-4">Account Created!</h2>
          ...
          <Card>
            <div className="text-center mb-8">
              ...
              <p className="text-text-secondary">
                Join EyeWear India and discover your perfect frames
              </p>
            </div>

            {errors.submit && (
              <div className="mb-4 p-3 bg-error-bg border border-error rounded-lg text-error text-sm">
                {errors.submit}
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-4 top-10 text-text-tertiary hover:text-text-primary"
                >
