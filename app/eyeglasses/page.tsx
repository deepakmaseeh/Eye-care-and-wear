  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="container-custom py-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold font-heading mb-2">Eyeglasses</h1>
          <p className="text-text-secondary">
            Find the perfect eyeglasses for your vision needs
          </p>
        </div>
          ...
          <div className="flex-1">
            ...
            {loading ? (
              ...
              <div className="text-center py-16">
                <p className="text-text-secondary">No eyeglasses found. Try adjusting your filters.</p>
              </div>
            )}
          </div>
        </div>
